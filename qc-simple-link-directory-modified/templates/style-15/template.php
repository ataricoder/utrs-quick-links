...
?>
                  ...
                  <li class="opt-column-0<?php echo $column; ?>" id="pd_bookmark_li_<?php echo $b; ?>" <?php echo $tooltip_content; ?>>
						...
						<div id="sldinfo-<?php echo $list['postid'] ."-". $b; ?>" class="white-popup mfp-hide">
                        ...
                        <div class="qc-sld-main">
                          <div class="qc-feature-media image">
                            ...
                            <div class="upvote-section">
								...
								<?php if( $upvote == 'on' ) : ?>
                                <div class="favourite">
                                    <span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo trim($list['qcopd_item_title']); ?>" data-item-link="<?php echo $list['qcopd_item_link']; ?>" class="sld-upvote-btn upvote-on">
