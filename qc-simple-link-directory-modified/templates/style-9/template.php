				...
				<ul class="tooltip_tpl9-tpl" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>" <?php echo ($removetop=='yes'?'style="border-top:unset !important;"':''); ?>>
					...
					<li id="item-<?php echo get_the_ID() ."-". $count; ?>">
						...
						<?php if(sld_is_youtube_video($item_url)): ?>
							...
							<a class="open-mpf-sld-video sld_load_video" href="#" data-mfp-src="#sldvideo-<?php echo $count; ?>" <?php echo $toolipsetup; ?> data-itemid="<?php echo get_the_ID(); ?>" data-videourl="<?php echo $list['qcopd_item_link']; ?>" data-itemsid="<?php echo $list['qcopd_timelaps']; ?>" data-tag="<?php echo (isset($list['qcopd_tags'])?$list['qcopd_tags']:'' ); ?>">
