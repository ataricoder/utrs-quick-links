				...
				<ul class="tooltip_tpl12-tpl sld-list" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>">
					...
					<li id="item-<?php echo get_the_ID() ."-". $count; ?>">
						...
						<?php if(sld_is_youtube_video($item_url)): ?>
							...
							<a class="open-mpf-sld-video sld_load_video tooltip-element tooltip_tpl8 fade" href="#" data-mfp-src="#sldvideo-<?php echo $count; ?>" <?php echo $toolipsetup; ?> data-itemid="<?php echo get_the_ID(); ?>" data-videourl="<?php echo $list['qcopd_item_link']; ?>" data-itemsid="<?php echo $list['qcopd_timelaps']; ?>" >
						...
						<?php elseif(sld_is_vimeo_video($item_url)): ?>
							...
							<a class="open-mpf-sld-video sld_load_video tooltip-element tooltip_tpl8 fade" href="#" data-mfp-src="#sldvideo-<?php echo $count; ?>" <?php echo $toolipsetup; ?> data-itemid="<?php echo get_the_ID(); ?>" data-videourl="<?php echo $list['qcopd_item_link']; ?>" data-itemsid="<?php echo $list['qcopd_timelaps']; ?>" data-tag="<?php echo (isset($list['qcopd_tags'])?$list['qcopd_tags']:'' ); ?>">
