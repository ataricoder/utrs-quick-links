...
function cmb_qcopd_dir_fields( array $meta_boxes ) {
	...
	$qcopd_item_fields = array(
		...
		array( 'id' => 'qcopd_image_from_link',  'name' => __('Generate Image from Website Link','qc-pd'), 'type' => 'checkbox', 'cols' => 3, 'default' => 0, 'desc' => '' ),
		...
		array( 'id' => 'qcopd_tags',  'name' => __('Tags','qc-pd'), 'type' => 'text', 'cols' => 3, 'default' => '', 'desc' => '' ),
		array( 'id' => 'qcopd_unpublished',  'name' => __('Unpublish this Item','qc-pd'), 'type' => 'checkbox', 'cols' => 3, 'default' => 0, 'desc' => '' ),	
		array( 'id' => 'qcopd_other_list',  'name' => __('Copy this item to other Lists','qc-pd'), 'type' => 'text', 'cols' => 3, 'default' => '', 'desc' => '' ),
