...
<form action="" method="POST" enctype="multipart/form-data">
	<ul class="sld_form-style-1 sld_width">
		...
		<li><label><?php echo __('Link Title', 'qc-opd') ?> <span class="sld_required">*</span></label><input type="text" name="item_title" id="sld_title" class="field-long sld_text_width" value="<?php echo esc_html($row->item_title); ?>" required/></li>
		<li>
