...
<div class="hero_tab">
    ...
    <button class="hero_tablinks" onclick="openCity(event, 'hero_widget')">Widget Shortcode</button>
		...
		<div id="hero_widget" class="hero_tabcontent" style="padding: 6px 12px;">
            <div class="qcsld_single_field_shortcode">
                ...
                <select style="width: 225px;" id="sld_widget_area">
                    <option value="tabstyle">Widget Tab Style</option>
                    <option value="latest">Latest Widget</option>
                    <option value="popular">Popular Widget</option>
                    <option value="random">Random Widget</option>
            ...
            <input class="sld-sc-btn" type="button" id="qcsld_add_shortcode_widget" value="Add Shortcode" />
        </div>
        </div>
		...
		<div class="sld_shortcode_container" style="display:none;">
			<div class="qcsld_single_field_shortcode">
				...
				<p><b>Copy</b> the shortcode & use it any text block.</p>
            </div>
		</div>
		</div>
