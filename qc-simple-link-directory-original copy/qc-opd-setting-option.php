...
array(
	...
	array(
		...
		'type'        => 'Textblock',
		'desc'        => __('You must add the following shortcode on a new page first:  [qcopd-directory-multipage]  . This page will be the base of your directory and show the list categories.<br><br>Please use [qcopd-directory-multipage] shortcode for sld multipage.<br><span style="color:red">For Multi Page Mode to Work You Must Create Categories and Assign Lists to Relevant Categories.</span><br>After adding this shortcode on a page you have to flush WordPress URL rewrite rules. Please go to <b>Settings > Permalinks</b> then click the <b>Save Changes</b> button Or you can click the button below to flush rewrite rules quickly.<br>For multi page directory we suggest uploading custom images. Recommended size 300px by 300px. Multi page mode supports one default template only.<div id="sld_flash_msg"></div><br><button id="sld_flash_button" class="option-tree-ui-button button button-primary">Flush Rewrite Rules</button> '),
		'std'         => '',
		'rows'        => '',
		'post_type'   => '',
		'taxonomy'    => '',
	...
	array(
		...
		'label'       => __( 'Select Style for Multipage', 'text-domain' ),
		'desc'        => __( '', 'text-domain' ),
		'type'        => 'select',
		'section'     => 'multipage',
		'choices'     => array(
			array(
				...
				'label'       => __( 'Multipage Style 2', 'text-domain' ),
			),
			array(
				'value'       => 'style-multipage',
				'label'       => __( 'Multipage Style 1', 'text-domain' ),
			),
			array(
				'value'       => 'style-10-multipage',
				'label'       => __( 'Multipage Style 3', 'text-domain' ),
			),
	...
	array(
		...
		'type'        => 'Textblock',
		'desc'        => __('[sld-multipage-category] <br><br>  Once you add the main multi page shortcode on a page of its own you can also add the following shortcode on home page or any other page to display multipage categories: [sld-multipage-category]. <br> When a category is clicked, it will redirect to the main directory page where you added the main shortcode and show the Lists under a category.'),
